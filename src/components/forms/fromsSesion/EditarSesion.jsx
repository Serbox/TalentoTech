    ...
    <div className="container text-left p-0">
      <div className="d-flex flex-row justify-content-center w-100 h-100">
        ...
        <div className="col p-3 ">
          <h2 className="font-extrabold text-3xl text-blue-900 text-left rounded-md">Editar SESIÓN</h2>
          ...
          <div className="d-flex flex-row justify-content-evenly pt-2">
            <button type="submit" className="btn bg-blue-700 hover:bg-blue-600 text-white font-bold py-2 px-4 border-b-4 border-blue-900 hover:border-blue-700 rounded">Editar</button>
          </div>
        </div>
      </div>
    </div>
