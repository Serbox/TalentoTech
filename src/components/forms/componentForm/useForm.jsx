    ...
    <form onSubmit={handleSubmit}>
      <div className="container text-left p-0">
        <div className="d-flex flex-row justify-content-center w-100 h-100">
          <div className="col">
            <img src={RegisterImg} alt="Registro" id="image" className="rounded-l-3xl"></img>
          </div>
          <div className="col p-3">
            ...
            <div className="row m-0 d-flex flex-row justify-content-between py-2">
              <div className="col d-flex flex-column justify-content-center gap-1">
                <label htmlFor="number-input" className="block mb-2 text-base text-gray-700 font-medium">Cédula:</label>
                <input type="number" id="number-input" name="cedula" value={formData.cedula} onChange={handleChange} className="bg-gray-50 border border-blue-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="90210" required />
              </div>
              <div className="col d-flex flex-column justify-content-center gap-1">
                <label htmlFor="nombre" className="block mb-2 text-base text-gray-700 font-medium">Nombre:</label>
                <input type="text" id="nombre" name="nombre" value={formData.nombre} onChange={handleChange} className="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5" placeholder="Elon Musk" />
              </div>
            </div>
            ...
            <div className="row m-0 d-flex flex-row justify-content-between py-2">
              <div className="col d-flex flex-column justify-content-center gap-1">
                ...
                <input type="text" id="ciudad" name="ciudad" value={formData.ciudad} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Bogota D.C" required />
              </div>
              <div className="col d-flex flex-column justify-content-center gap-1">
            ...
            <div className="row m-0 d-flex flex-row justify-content-between py-2">
              ...
              <div className="col d-flex flex-column justify-content-center gap-1">
                ...
                <input type="tel" id="telefono" name="telefono" value={formData.telefono} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890" required />
              </div>
            </div>
            ...
            <div className="row m-0 d-flex flex-row justify-content-between py-2">
              ...
              <div className="col d-flex flex-column justify-content-center gap-1">
                ...
                <input type="password" id="confirmPassword" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="•••••••••" required />
              </div>
            </div>
