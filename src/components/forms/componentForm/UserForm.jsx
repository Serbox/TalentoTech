          ...
          <div className="flex flex-col p-3 content-between w-100 h-100 shadow-sm">
            ...
            <div className="border w-28 border-spacing-24 border-blue-950 mb-2 gap-2"></div>
              ...
              <div className="col d-flex flex-column justify-content-center pb-2">
                <label htmlFor="nombre" className="block text-base font-medium text-gray-400">Nombre y Apellido :</label>
                <div className="flex">
              ...
              <div className="col d-flex flex-column justify-content-center gap-1 pb-2">
                <label htmlFor="correo" className="block text-base font-medium text-gray-400">Correo:</label>
              ...
              <div className="row m-0 d-flex flex-row justify-content-between pb-2">
                ...
                <div className="col d-flex flex-col justify-content-center p-0">
                  <label htmlFor="cedula" className="block text-base font-medium text-gray-400">Cedula :</label>
                ...
                <div className="col d-flex flex-column justify-content-center p-0 ps-2">
                  <label htmlFor="telefono" className="block text-base font-medium text-gray-400">Teléfono:</label>
                  <div className="flex w-100 h-100">
              ...
              <div className="row m-0 d-flex flex-row justify-content-between py-2">
                {/*Fecha de nacimiento*/}
                <div className="col d-flex flex-col justify-content-center p-0">
                  <label htmlFor="fecha_nacimiento" className="block text-base font-medium text-gray-400">Fecha de nacimiento:</label>
                  <div class="flex w-100 h-100">
                ...
                {/*Bootcamp*/}
                <div className="col d-flex flex-column justify-content-center p-0 ps-2">
                  <label htmlFor="bootcamp" className="block text-base font-medium text-gray-400">Bootcamp:</label>
                  <div class="flex w-100 h-100">
                    <span class="inline-flex items-center px-2 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md">
            ...
            <div className="row m-0 d-flex flex-row justify-content-between py-2">
              <div className="col d-flex flex-col justify-content-center p-0">
                <label htmlFor="password" className="block text-base font-medium text-gray-400">Contraseña:</label>
                <input 
                  type="password" 
                  id="password" 
                  name="password" 
              ...
              <div className="col d-flex flex-column justify-content-center p-0 ps-2">
                <label htmlFor="confirmPassword" className="block text-base font-medium text-gray-400">Confirmar contraseña:</label>
                <input 
                  type="password" 
                  id="confirmPassword" 
