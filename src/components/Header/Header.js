        ...
        <nav className='shadow-md w-full fixed top-0 left-0  z-10'>
            ...
            {/*Nav Link*/}
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-blue-900 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${!isOpen ? 'top-12':'top-[-490px]'}`}>
                    ...
                    <li className='relative flex flex-col font-semibold my-6 md:my-0 md:ml-8 hover:border-b-4 hover:border-x-2 hover:border-t-2 hover:border-blue-950 p-2 rounded-xl hover:shadow-md hover:shadow-blue-950'>
                        <a href='#' onClick={() => setisOpenOptions((prev) => !prev)} className='w-full flex justify-between font-semibold text-white text-lg decoration-transparent p-0 gap-2 items-center px-3 hover:text-lg hover:font-bold tracking-wider'>
                            ...
                            {isOpenOptions && (
                                <div className='bg-white absolute top-12 left-0 flex flex-col items-start rounded-lg p-1 w-full shadow-md shadow-blue-950 border-2 border-blue-950'>
                    ...
                    <li className=" relative flex flex-col items-center font-semibold my-7 md:my-0 md:ml-8 bg-blue-900  border-b-4 border-x-2 border-t-2  border-blue-950 p-2 rounded-xl shadow">
