        ...
        <nav className='shadow-md w-full sticky top-0 left-0  z-10'>
            ...
            {/*Nav Link*/}
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-blue-900 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${!isOpen ? 'top-12':'top-[-490px]'}`}>
                    ...
                    <li className='font-semibold my-6 md:my-0 md:ml-8'>
                        <a href='/' className='block font-semibold text-white text-lg decoration-transparent p-0 hover:text-xl hover:font-bold'><i className="bi bi-grid-fill px-2"></i>Opciones</a>
                    </li>
                    <li className='font-semibold my-6 md:my-0 md:ml-8'>
                    ...
                    <li className=" relative flex flex-col items-center font-semibold my-7 md:my-0 md:ml-8 bg-blue-950  border-b-4  border-sky-950 p-2 rounded-xl shadow">
                            <a href='#' onClick={() => setisOpend((prev) => !prev)} className='w-full flex justify-between font-sbold text-white text-lg decoration-transparent p-0 gap-2 items-center px-3 hover:text-lg hover:font-semibold tracking-wider'>
                                    ...
                                    <div className='bg-blue-950 absolute top-14 left-0 flex flex-col items-start rounded-lg p-2 w-full shadow-black'>
                                        <div className='flex flex-row w-full h-full items-center bg-slate-50 hover:bg-slate-200 rounded-lg p-1'>
                                            <div className='flex flex-col px-2 w-full '>
                                                    <h4 className='text-gray-700 text-lg font-bold p-0 m-0 text-center'>Sylvanas</h4>
                                                    <h4 className='text-gray-700 text-lg font-bold p-0 m-0 text-center'>Hayase</h4>
                                                <div className='text-base text-center text-sky-500 font-bold'>
                                                    Sylvanas@
                                                </div>

                                            </div>
                                            <div className='bg-gray-300 rounded-full p-0 mx-2'>
